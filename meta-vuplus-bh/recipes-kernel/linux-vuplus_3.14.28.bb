...
do_configure_prepend() {
	...
	if [ -f ${S}/drivers/media/bh-api/bh_version.h ]; then
		echo > ${S}/drivers/media/bh-api/bh_version.h
		echo "#ifndef _BH_VERSION_H_" >> ${S}/drivers/media/bh-api/bh_version.h
		echo "#define _BH_VERSION_H_" >> ${S}/drivers/media/bh-api/bh_version.h
		echo "" >> ${S}/drivers/media/bh-api/bh_version.h
		echo "#define BH_API_VERSION \"${BH_DISTRO_VERSION}\"" >> ${S}/drivers/media/bh-api/bh_version.h
		echo "" >> ${S}/drivers/media/bh-api/bh_version.h
		echo "#endif /\* _BH_VERSION_H_ \*/" >> ${S}/drivers/media/bh-api/bh_version.h
	fi
}
