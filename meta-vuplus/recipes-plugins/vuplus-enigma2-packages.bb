...
do_install() {
	...
	install -d  ${D}/usr/lib/enigma2/python/Plugins/SystemPlugins/VuplusBlindscan
	install -d  ${D}/usr/lib/enigma2/python/Plugins/SystemPlugins/AnimationSetup
	...
	${D}/usr/lib/enigma2/python/Plugins/SystemPlugins/VuplusBlindscan
	
	install -m 0644 ${S}/lib/python/Plugins/SystemPlugins/AnimationSetup/*.py \
	${D}/usr/lib/enigma2/python/Plugins/SystemPlugins/AnimationSetup
...
FILES_enigma2-plugin-systemplugins-vuplusblindscan = "/usr/lib/enigma2/python/Plugins/SystemPlugins/VuplusBlindscan"
FILES_enigma2-plugin-systemplugins-animationsetup = "/usr/lib/enigma2/python/Plugins/SystemPlugins/AnimationSetup"
...
PACKAGES = "\
	...
	enigma2-plugin-systemplugins-vuplusblindscan \
